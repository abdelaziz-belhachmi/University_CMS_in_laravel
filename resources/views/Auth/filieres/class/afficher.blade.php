...
<div style="justify-content:center;">
    ...
    <section class="section Classs" id="Classs">
        <div class="wrapper">
            ...
            <p class="section__solg" >Classe</p>
                ...
                <div class="Class-card">
                        ...
                        <div class="Class-infos">
                            ...
                            <div id="bouttons-crud" >
                                ...
                                <button onclick="supprimer('{{$Cl->id}}')" style="background-color:rgb(201, 39, 72)">Supprimer</button>
                            </div>
                            @endif
    ...
    <script>
        ...
        function associer(id){
            window.location.href='/class/modifier/'+id;
